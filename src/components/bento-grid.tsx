      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <div className="flex items-start justify-between mb-8">
              <div>
                ...
                <h3 className="text-xl font-semibold text-white mb-2">{m.bento_monitoring_title()}</h3>
                <p className="text-zinc-400 text-sm">
                  {m.bento_monitoring_desc()}
                </p>
              </div>
              <SystemStatus />
            </div>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{m.bento_command_title()}</h3>
            <p className="text-zinc-400 text-sm mb-6">{m.bento_command_desc()}</p>
            <KeyboardCommand />
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{m.bento_analytics_title()}</h3>
            <p className="text-zinc-400 text-sm mb-4">{m.bento_analytics_desc()}</p>
            <AnimatedChart />
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{m.bento_performance_title()}</h3>
            <p className="text-zinc-400 text-sm mb-4">
              {m.bento_performance_desc()}
            </p>
            <div className="flex items-center gap-2 text-emerald-500 text-sm">
              <span className="font-mono">~32ms</span>
              <span className="text-zinc-500">{m.bento_performance_avg_response()}</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{m.bento_security_title()}</h3>
            <p className="text-zinc-400 text-sm mb-4">{m.bento_security_desc()}</p>
            <div className="flex items-center gap-2">
